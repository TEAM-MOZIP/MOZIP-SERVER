...
import com.mozip.server.bookmark.exception.InvalidSortFieldException;
import org.junit.jupiter.api.Test;
import org.springframework.data.domain.PageRequest;
import org.springframework.data.domain.Pageable;
import org.springframework.data.domain.Sort;

class BookmarkSortValidatorTest {
    ...
    void 허용된_필드로_정렬하면_뒤에_id_DESC_tie_break가_추가된다() {
        ...
        Pageable validated = BookmarkSortValidator.validate(pageable);
    ...
    void 허용되지_않은_필드로_정렬하면_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> BookmarkSortValidator.validate(pageable))
