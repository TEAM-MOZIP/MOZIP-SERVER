...
public class TermExplanationClient {

    private static final String EXPLAIN_URI = "/api/v1/terms/explain";

    private final RestClient restClient;

    @Autowired
    public TermExplanationClient(RestClient.Builder restClientBuilder, MozipAiProperties properties) {
     ...
     * 덮어쓰지 않는다.
     */
    TermExplanationClient(RestClient restClient) {
    ...
    public TermExplainResponse explain(TermExplainRequest request) {
        return restClient.post()
                ...
                .body(request)
                .retrieve()
                .body(TermExplainResponse.class);
    }
}
