...
public class PolicySummaryClient {
    ...
    private static final String GENERATE_URI = "/api/v1/summaries/generate";

    private final RestClient restClient;

    @Autowired
    public PolicySummaryClient(RestClient.Builder restClientBuilder, MozipAiProperties properties) {
     ...
     * 덮어쓰지 않는다.
     */
    PolicySummaryClient(RestClient restClient) {
    ...
    private static RestClient buildRestClient(RestClient.Builder restClientBuilder, MozipAiProperties properties) {
        ClientHttpRequestFactorySettings settings = ClientHttpRequestFactorySettings.defaults()
                ...
                .withReadTimeout(Duration.ofSeconds(properties.resolvedSummaryTimeoutSeconds()));
    ...
    public PolicySummaryResponse generate(PolicySummaryRequest request) {
        return restClient.post()
                .uri(GENERATE_URI)
                .body(request)
                .retrieve()
                .body(PolicySummaryResponse.class);
    }
}
